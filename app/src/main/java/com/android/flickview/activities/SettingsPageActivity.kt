...
class SettingsPageActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val buttonRegion: Button = findViewById(R.id.button_region)
        ...
        val buttonDisplay: Button = findViewById(R.id.button_display)
        ...
        val buttonNotifications: Button = findViewById(R.id.button_notifications)
       ...
       // }
        ...
        val buttonCopyright: Button = findViewById(R.id.button_copyright)
        ...
        val buttonRate: Button = findViewById(R.id.button_rate)
